...
class ProductGUI(QMainWindow):
    ...
    def clear_button_clicked(self):
        # TODO: Bring your code from Exercise B to allow clearing fields. 




        # TODO: After the fields are clear, you need to set them to be editable.
        # You need to do that to be able to add new products.
    ...
    def search_button_clicked(self):
        ''' 'search product '''
        # TODO: Bring your code from Exercise B to allow for searches. 
